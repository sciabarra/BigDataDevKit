...
docker run --name term -p "2222:2222" -v /etc/cert:/etc/cert -u term -d nathanleclaire/wetty app.js --port 2222 --sshhost $(hostname -I | awk '{ print $1}') --sshuser ec2-user --sslkey /etc/cert/cert.key --sslcert /etc/cert/cert.pem
# end script
